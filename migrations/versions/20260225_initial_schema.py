...
def upgrade() -> None:
    ...
    op.create_unique_constraint(
        "uq_user_account_email", "gmail_accounts", ["user_id", "account_email"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "account_sources", postgresql.ARRAY(sa.String), nullable=False, server_default="{}"
        ),
    ...
    op.create_unique_constraint(
        "uq_account_message_id", "emails", ["account_id", "gmail_message_id"]
    )
